...
modify the contents of the `src/everos_cloud/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/evermemos/everos-cloud-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/evermemos/everos-cloud-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
